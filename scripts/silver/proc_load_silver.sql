...
BEGIN
    ...
    RAISE NOTICE '>> Load Duration: % seconds', seconds_diff;
    RAISE NOTICE '>> -------------';
    ...
    seconds_diff := EXTRACT(EPOCH FROM (batch_end_time - batch_start_time));
    RAISE NOTICE '==========================================';
    RAISE NOTICE 'Loading Silver Layer is Completed';
    RAISE NOTICE '   - Total Load Duration: % seconds', seconds_diff;
    RAISE NOTICE '==========================================';
